...
const OrderScreen = ({ match }) => {
  ...
  const orderDeli = useSelector((state) => state.orderDeli);
  const { loading: loadingPay, success: successPay } = orderDeli;
        ...
        <div>
          <div className="order_shipping">
            ...
            {order.isDelivered ? (
              ...
              <Message>Chờ xác nhận giao hàng giao hàng</Message>
            )}
          </div>
