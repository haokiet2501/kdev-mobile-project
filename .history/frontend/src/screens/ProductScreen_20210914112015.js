...
const ProductScreen = ({ history, match }) => {
  ...
  const productCreateReview = useSelector((state) => state.createProductReview);
  const {
            ...
            <div className="productreview">
              ...
              <div className="review">
                ...
                <div>
                  ...
                  {userInfo ? (<h1></h1>) : <Message>Vui lòng <Link to="/login">Đăng nhập</Link> để viết đánh giá</Message>}
                </div>
              </div>
            </div>
          </div>
