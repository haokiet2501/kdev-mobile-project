...
import { ORDER_PAY_RESET } from "../contants/orderContants";
      ...
      <div className="order_col">
        <div>
          <div className="order_shipping">
            ...
            {order.isDelivered ? (
              <Message>Đã xác nhận {order.deliveredAt}</Message>
            ) : (
              <Message>Chờ xác nhận giao hàng</Message>
            )}
          </div>
          ...
          <div className="order_payment">
            ...
            {order.isPaid ? (
              <Message style={{color: "green", disp}}>Đã thanh toán {order.paidAt}</Message>
            ) : (
