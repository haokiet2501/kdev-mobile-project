      ...
      <div className="order_col">
        <div>
          <div className="order_shipping">
            ...
            {order.isDelivered ? (
              <Message className="alert_green">Đã xác nhận {order.deliveredAt}</Message>
            ) : (
              <Message>Chưa xác nhận đơn hàng</Message>
            )}
          </div>
          ...
          <div className="order_payment">
            ...
            {order.isPaid ? (
              <Message className="alert_green">Đã thanh toán {order.paidAt}</Message>
            ) : (
