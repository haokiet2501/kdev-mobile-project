              ...
              <div>
                {product.reviews.map((review) => (
                  <div className="review" key={review._id}>
                    ...
                    <p className="comment-time">Thời gian: {review.createdAt.substring(0, 10)}</p>
                    <p className="comment">Đánh giá: {review.comment}</p>
                  </div>
                ))}
                <div>
                  {errorProductReview && (
                  ...
                  {userInfo ? (
                    ...
                    <Message disabled>
                      Vui lòng <Link style={{color: "#2691d9"}} to="/login">Đăng nhập</Link> để viết đánh
                      giá
                    </Message>
                  )}
                </div>
